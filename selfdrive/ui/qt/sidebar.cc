...
void Sidebar::drawMetric(QPainter &p, const QPair<QString, QString> &label, QColor c, int y) {
  ...
  p.drawText(rect.x() + 50, rect.top() + 19, rect.width(), rect.height(), Qt::AlignCenter, label.first);
  p.drawText(rect.x() + 50, rect.top() + 65, rect.width(), rect.height(), Qt::AlignCenter, label.second);
}
